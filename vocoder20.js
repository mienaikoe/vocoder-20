...
oz.frequency.value=8*M.pow(2,i/12);z=c._G();z.gain.value=0;oz.to(z);ox[i]=z;
hb=d.ce("div");hv=hb.style;d.body.appendChild(hb);hx[i]=hv;hv.opacity=0;
hb.innerHTML=String.fromCharCode(i);}d.body.style.height="100%";d.m=mic;
...
ob=c._F();ob.type="bandpass";mf.frequency.value=10;ob.frequency.value=fr;
...
w=window;w.a=w.addEventListener;function et(v){return function(ev){
_=ev.keyCode;if(_>64 && _<91){ox[_].gain.value=v;hx[_].opacity=v;}};}
